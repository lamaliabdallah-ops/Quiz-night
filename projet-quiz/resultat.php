...
foreach($questions as $q){
    ...
    foreach($reponses as $r){
        if($r['id_question_quiz'] == $q['id']){
           if($r['isTrue'] == 1){
                echo "<p class='rep-true'>" . htmlspecialchars($r['reponse']) . "</p>";
            } else {
                echo "<p class='rep-false'>" . htmlspecialchars($r['reponse']) . "</p>";
            }
        }
    }
...
?>
<a href="Tous les quizz.php" class="btn-annuler">Voir tout les quiz</a>
